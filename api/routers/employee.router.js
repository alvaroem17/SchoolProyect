...
const { checkAuth,checkAdmin, checkPassword } = require('../middleware')
...
router.put('/:employeeId', checkAuth, checkPassword , checkAdmin,updateEmployee)
router.post('/',checkAuth , checkAdmin, checkPassword,createEmployee)
